...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-%i0@6gwbaidmsp^%@#*#kneyex_^91@d(4jpeppj30(c9mhsec')
...
DATABASES = {
    'default': dj_database_url.config(
        default='postgresql://postgres:admin@localhost:5432/portafolio',
        conn_max_age=600
    )
}
